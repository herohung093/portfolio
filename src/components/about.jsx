          ...
          <div className="col-md-12 col-lg-6">
            <div className="about-details">
              ...
              <p className="mb-15" style={{ color: "#6c757d" }}>
                ...
                for clients ranging from individuals and businesses. I have done
                works in software development, Android app creation,
                front-end/back-end web, database/server management.
              </p>
              <ul className="py-15">
                <li>
